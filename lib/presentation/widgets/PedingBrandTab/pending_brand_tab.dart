...
class PendingBrandTab extends StatelessWidget {
  const PendingBrandTab({super.key});
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: ListView.separated(itemBuilder: (context, index) {
        return  InkWell(
          onTap: () => Navigator.pushNamed(context, AppRoutes.pendingDetailsScreen, arguments: "requested"),
