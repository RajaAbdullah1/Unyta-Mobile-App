...
class CompletedBrandTab extends StatelessWidget {
  const CompletedBrandTab({super.key});
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: ListView.separated(itemBuilder: (context, index) {
        return  InkWell(
          onTap: () => Navigator.pushNamed(context, AppRoutes.completedDetailScreen, arguments: "requested"),
          child: MyCampaignBrandCard(
