...
import '../../../../widgets/ExploreCreatorBrandCard/explore_creator_brand_card.dart';
import '../../../../widgets/HomeAppBar/home_app_bar.dart';

class ExploreCreatorScreen extends StatelessWidget {
  const ExploreCreatorScreen({super.key});
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          Positioned.fill(
            child: Image.asset(
              'assets/images/explore_creators.jpg',
              fit: BoxFit.cover,
            ),
          ),
